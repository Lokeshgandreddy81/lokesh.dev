...
const App: React.FC = () => {
            ...
            <div className="flex flex-col h-full bg-white p-8 animate-in slide-in-from-bottom duration-300">
                 ...
                 <div className="mt-auto pt-8 text-center">
                    <p className="text-xs text-slate-400 font-medium">
                        Don't have an account? <span className={`text-${themeColor}-600 font-bold cursor-pointer hover:underline`}>Sign Up</span>
                    </p>
                 </div>
            </div>
          );
  ...
  return (
    <div className="h-full flex flex-col items-center justify-center bg-slate-100">
       ...
       <div className="w-full h-full md:h-[844px] md:w-[390px] bg-white md:rounded-[3rem] md:shadow-2xl overflow-hidden relative border-[8px] border-slate-800">
          {authStage !== 'APP' ? (
              renderAuthScreens()
          ) : (
            <>
